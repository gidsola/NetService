...
export function SetHeaders(res) {
    ...
    res.setHeader('Content-Security-Policy', "style-src 'self' 'unsafe-inline'; font-src 'self'; img-src 'self'; frame-src 'self'; base-uri 'none'; form-action 'self'; frame-ancestors 'none';");
